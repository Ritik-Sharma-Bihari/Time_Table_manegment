...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{			
			...
			User u=dao.getUserByTableNameIDAndPassword(type,id,password);
			
			
			
	          /*
	           * this is for retrive the faculty timing data 
	           */
        	...
        	//	save..
        		...
        		/*
        		 * so here in the session will are going to store the object of User class
        		 * which is having the userid, usename,and password. only
        		 */
  
  	          HttpSession s2=request.getSession();
  	           s2.setAttribute("listt",u.getId()); 
        		// this is id of faculty.
  	          
  	          /*
  	           * in this session we are only storing the usser id
  	           */
