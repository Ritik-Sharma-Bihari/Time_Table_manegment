                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-white ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            ...
                            <a class="nav-link" id="menuitem1" href="syllabus_admin.jsp">subject <span
                            ...
                            <a class="nav-link" id="menuitem4" href="Admin_page.jsp">home</a>
                    ...
                    <div class="detailed-view-bg-container d-flex flex-column justify-content-center">
                        ...
                        <div class="containerrr d-flex flex-row justify-content-center">

                            <div class="containerr" style="width:50% ">

                                <form action="Admin_Servlet_Course" method="post">


                                    <div class="card-header text-center mb-3">
                                        <span class="fa fa-user-plus fa-2x"></span>
                                        <p>course Profile Form </p>
                                    </div>
                        ...
                        or which is send by loginservlet
                         ...
                         -->
                                    ...
                                    <% Message_class m=(Message_class) session.getAttribute("msg"); if (m !=null) { %>
                                        ...
                                        <% session.removeAttribute("msg"); // to delete the session other wise it will
                                             } %>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td class="pl-3"> <label for="course">select operation:</label>
                                                    </td>
                                                    <td class="pl-5" style="width: 350px; height: 40px;">

                                                        <select id="admin_course" name="admin_course_operation"
                                                            class="form-control">
                                                ...
                                                <tr>
                                                    <td class="pl-3"> <label for="course_id">Enter Course Id</label>
                                                    </td>
                                                    <td class="pl-5">

                                                        <input name="course_id" type="text" class="form-control"
                                                            id="course_id" placeholder="write here " required>
                                                        <small id="idlHelp" class="form-text text-muted ">plz. write in
                                                            combination of
                                                            alphabetic and numeric</small>
                                                ...
                                                <tr>
                                                    <td class="pl-3"> <label for="course_name">Enter Course Name</label>
                                                    </td>
                                                    <td class="pl-5">

                                                        <input name="course_name" type="text" class="form-control"
                                                            id="course_name" placeholder="write here " required>
                                                ...
                                                <tr>
                                                    <td class="pl-3"> <label for="course_year">Enter Year</label> </td>
                                                    <td class="pl-5">
                                                        <input name="course_year" type="text" class="form-control"
                                                            id="course_year" placeholder="write here" required>
                                                        <small id="idlHelp" class="form-text text-muted">plz. write in
                                                            numeric like-first-first,first-second
                                                            .</small>
                                                ...
                                                <tr>
                                                    <td class="pl-3"> <label for="course_section">Enter section</label>
                                                    </td>
                                                    <td class="pl-5">
                                                        <input name="course_section" type="text" class="form-control"
                                                            id="course_section" placeholder="enter course section"
                                                            required>
                                                        <small id="idlHelp" class="form-text text-muted">plz. write in
                                                            numeric like-a to b
                                                            .</small>
