                    ...
                    <div class="detailed-view-bg-container d-flex flex-column justify-content-center">
                        ...
                        <div class="containerrr d-flex flex-row justify-content-center">
                            ...
                            <div class="containerr" style="width:50%">
                                ...
                                <form action="Admin_Servlet_Syllabus" method="post">


                                    <div class="card-header text-center mb-3">
                                        <span class="fa fa-user-plus fa-2x"></span>
                                        <p>Subject Profile Form </p>
                                    </div>
                                    ...
                                    if (m !=null) { %>
                                        ...
                                        <% session.removeAttribute("msg"); // to delete the session other wise it will 
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td class="pl-2"> <label for="admin_syllabus">select
                                                            operation:</label>
                                                    </td>
                                                    <td class="pl-5" style="width: 350px; height: 40px;">


                                                        <select id="admin_syllabus" name="admin_syllabus_operation"
                                                            class="form-control">
                                                ...
                                                <tr>
                                                    <td class="pl-2"> <label for="syllabus_id">Enter ID number</label>
                                                    </td>
                                                    <td class="pl-5">

                                                        <input name="syllabus_id" type="text" class="form-control"
                                                            id="syllabus_id" placeholder="plz.write in numeric"
                                                            required>
                                                ...
                                                <tr>
                                                    <td class="pl-2"> <label for="syllabus_name">Enter Syllabus
                                                            Name</label>
                                                    </td>
                                                    <td class="pl-5">

                                                        <input name="syllabus_name" type="text" class="form-control"
                                                            id="syllabus_name" placeholder="write here " required>
                                                    </td>
                                                </tr>
